...
.method protected final include(Landroid/view/View;Landroid/support/v7/widget/GridLayout$Spec;Landroid/support/v7/widget/GridLayout;Landroid/support/v7/widget/GridLayout$Axis;)V
    ...
    invoke-virtual {p3, p1, v0}, Landroid/support/v7/widget/GridLayout;->getMeasurementIncludingMargin(Landroid/view/View;Z)I

    move-result v0

    .line 2151
    iget-object v1, p2, Landroid/support/v7/widget/GridLayout$Spec;->alignment:Landroid/support/v7/widget/GridLayout$Alignment;

    iget-boolean v2, p4, Landroid/support/v7/widget/GridLayout$Axis;->horizontal:Z

    invoke-virtual {p3, v1, v2}, Landroid/support/v7/widget/GridLayout;->getAlignment(Landroid/support/v7/widget/GridLayout$Alignment;Z)Landroid/support/v7/widget/GridLayout$Alignment;

    move-result-object v1

    .line 2153
    invoke-virtual {v1, p1, v0}, Landroid/support/v7/widget/GridLayout$Alignment;->getAlignmentValue(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, v1, v0}, Landroid/support/v7/widget/GridLayout$Bounds;->include(II)V
