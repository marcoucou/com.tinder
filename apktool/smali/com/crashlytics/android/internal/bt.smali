.class public Lcom/crashlytics/android/internal/bt;
.super Ljava/lang/Object;
.source "SourceFile"


# instance fields
.field private final a:Lcom/crashlytics/android/internal/ch;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lcom/crashlytics/android/internal/bt;-><init>(Lcom/crashlytics/android/internal/ch;)V

    .line 32
    return-void
.end method

.method public constructor <init>(Lcom/crashlytics/android/internal/ch;)V
    .locals 0
    ...
    .line 35
    iput-object p1, p0, Lcom/crashlytics/android/internal/bt;->a:Lcom/crashlytics/android/internal/ch;
...
.method private declared-synchronized a()Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/crashlytics/android/internal/bt;->c:Ljavax/net/ssl/SSLSocketFactory;

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lcom/crashlytics/android/internal/bt;->d:Z

    if-nez v0, :cond_0

    .line 105
    invoke-direct {p0}, Lcom/crashlytics/android/internal/bt;->b()Ljavax/net/ssl/SSLSocketFactory;

    move-result-object v0

    iput-object v0, p0, Lcom/crashlytics/android/internal/bt;->c:Ljavax/net/ssl/SSLSocketFactory;
...
.method public static a([Ljava/security/cert/X509Certificate;Lcom/crashlytics/android/internal/ah;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static {v4, v5}, Lcom/crashlytics/android/internal/bt;->a(Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;)Z
...
.method private declared-synchronized b()Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    iput-boolean v0, p0, Lcom/crashlytics/android/internal/bt;->d:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 114
    :try_start_1
    iget-object v0, p0, Lcom/crashlytics/android/internal/bt;->b:Lcom/crashlytics/android/internal/af;
    ...
    .line 115
    iget-object v2, p0, Lcom/crashlytics/android/internal/bt;->a:Lcom/crashlytics/android/internal/ch;
...
# virtual methods
.method public a(Lcom/crashlytics/android/internal/ax;Ljava/lang/String;Ljava/util/Map;)Lcom/crashlytics/android/internal/bv;
    .locals 3
    ...
    .line 65
    sget-object v0, Lcom/crashlytics/android/internal/bu;->a:[I
    ...
    .line 67
    :pswitch_0
    invoke-static {p2, p3, v2}, Lcom/crashlytics/android/internal/bv;->a(Ljava/lang/CharSequence;Ljava/util/Map;Z)Lcom/crashlytics/android/internal/bv;
    ...
    .line 88
    invoke-direct {p0}, Lcom/crashlytics/android/internal/bt;->a()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 91
    invoke-virtual {v1}, Lcom/crashlytics/android/internal/bv;->a()Ljava/net/HttpURLConnection;
    ...
    .line 71
    :pswitch_1
    invoke-static {p2, p3, v2}, Lcom/crashlytics/android/internal/bv;->b(Ljava/lang/CharSequence;Ljava/util/Map;Z)Lcom/crashlytics/android/internal/bv;
    ...
    .line 75
    :pswitch_2
    invoke-static {p2}, Lcom/crashlytics/android/internal/bv;->a(Ljava/lang/CharSequence;)Lcom/crashlytics/android/internal/bv;
    ...
    .line 79
    :pswitch_3
    invoke-static {p2}, Lcom/crashlytics/android/internal/bv;->b(Ljava/lang/CharSequence;)Lcom/crashlytics/android/internal/bv;
