...
.field private final b:Lcom/crashlytics/android/internal/bh;

.field private c:Lcom/crashlytics/android/internal/ak;

.field private final d:Lcom/crashlytics/android/internal/bi;
...
.field private f:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
            "Lcom/crashlytics/android/internal/bj;",
            ">;"
        }
    .end annotation
.end field
...
# direct methods
.method constructor <init>(Lcom/crashlytics/android/internal/v;Lcom/crashlytics/android/internal/bh;Lcom/crashlytics/android/internal/bi;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/crashlytics/android/internal/j;-><init>(Lcom/crashlytics/android/internal/v;Lcom/crashlytics/android/internal/bh;Lcom/crashlytics/android/internal/bi;I)V

    .line 66
    return-void
.end method

.method private constructor <init>(Lcom/crashlytics/android/internal/v;Lcom/crashlytics/android/internal/bh;Lcom/crashlytics/android/internal/bi;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 55
    iput-object p3, p0, Lcom/crashlytics/android/internal/j;->d:Lcom/crashlytics/android/internal/bi;

    .line 56
    iput-object p2, p0, Lcom/crashlytics/android/internal/j;->b:Lcom/crashlytics/android/internal/bh;

    .line 58
    iget-object v0, p0, Lcom/crashlytics/android/internal/j;->b:Lcom/crashlytics/android/internal/bh;

    invoke-virtual {v0}, Lcom/crashlytics/android/internal/bh;->a()J
...
.method private a(Ljava/lang/String;)V
    ...
    check-cast v0, Lcom/crashlytics/android/internal/bj;

    .line 155
    :try_start_0
    invoke-interface {v0}, Lcom/crashlytics/android/internal/bj;->c()V
    :try_end_0
...
.method final a(Lcom/crashlytics/android/internal/bj;)V
    .locals 1
...
.method final a(Lcom/crashlytics/android/internal/u;)V
    ...
    iget-object v2, p0, Lcom/crashlytics/android/internal/j;->d:Lcom/crashlytics/android/internal/bi;

    invoke-direct {p0}, Lcom/crashlytics/android/internal/j;->e()I

    move-result v3

    invoke-virtual {v2, v1, v3}, Lcom/crashlytics/android/internal/bi;->a(II)Z
    ...
    iget-object v6, p0, Lcom/crashlytics/android/internal/j;->d:Lcom/crashlytics/android/internal/bi;

    invoke-virtual {v6}, Lcom/crashlytics/android/internal/bi;->a()I
    ...
    .line 72
    :cond_0
    iget-object v1, p0, Lcom/crashlytics/android/internal/j;->d:Lcom/crashlytics/android/internal/bi;

    invoke-virtual {v1, v0}, Lcom/crashlytics/android/internal/bi;->a([B)V
...
.method final a(Ljava/util/List;)V
    ...
    .prologue
    .line 167
    iget-object v0, p0, Lcom/crashlytics/android/internal/j;->d:Lcom/crashlytics/android/internal/bi;

    invoke-virtual {v0, p1}, Lcom/crashlytics/android/internal/bi;->a(Ljava/util/List;)V
...
.method final a()Z
    ...
    .line 93
    iget-object v3, p0, Lcom/crashlytics/android/internal/j;->d:Lcom/crashlytics/android/internal/bi;

    invoke-virtual {v3}, Lcom/crashlytics/android/internal/bi;->b()Z
    ...
    invoke-virtual {v3, v0}, Lcom/crashlytics/android/internal/bi;->a(Ljava/lang/String;)V
    ...
    .line 100
    iget-object v2, p0, Lcom/crashlytics/android/internal/j;->b:Lcom/crashlytics/android/internal/bh;

    invoke-virtual {v2}, Lcom/crashlytics/android/internal/bh;->a()J
...
.method final b()Ljava/util/List;
    ...
    invoke-virtual {v0, v1}, Lcom/crashlytics/android/internal/bi;->a(I)Ljava/util/List;
...
.method final c()V
    ...
    invoke-virtual {v1}, Lcom/crashlytics/android/internal/bi;->c()Ljava/util/List;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/crashlytics/android/internal/bi;->a(Ljava/util/List;)V

    .line 172
    iget-object v0, p0, Lcom/crashlytics/android/internal/j;->d:Lcom/crashlytics/android/internal/bi;

    invoke-virtual {v0}, Lcom/crashlytics/android/internal/bi;->d()V
...
.method final d()V
    ...
    invoke-virtual {v0}, Lcom/crashlytics/android/internal/bi;->c()Ljava/util/List;
    ...
    invoke-virtual {v0, v3}, Lcom/crashlytics/android/internal/bi;->a(Ljava/util/List;)V
