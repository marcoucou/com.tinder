...
.field private d:Lcom/crashlytics/android/internal/bn;

.field private e:Lcom/crashlytics/android/internal/aj;

.field private f:J

.field private g:Lcom/crashlytics/android/internal/bt;
...
.method static synthetic a(Lcom/crashlytics/android/internal/c;)V
    ...
    invoke-direct {v1}, Lcom/crashlytics/android/internal/bh;-><init>()V

    new-instance v2, Lcom/crashlytics/android/internal/bi;

    invoke-static {}, Lcom/crashlytics/android/internal/ck;->a()Lcom/crashlytics/android/internal/ck;

    move-result-object v3

    invoke-virtual {v3}, Lcom/crashlytics/android/internal/ck;->i()Ljava/io/File;
    ...
    invoke-direct {v2, v3, v4, v5}, Lcom/crashlytics/android/internal/bi;-><init>(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v9, Lcom/crashlytics/android/internal/j;

    invoke-direct {v9, v0, v1, v2}, Lcom/crashlytics/android/internal/j;-><init>(Lcom/crashlytics/android/internal/v;Lcom/crashlytics/android/internal/bh;Lcom/crashlytics/android/internal/bi;)V

    iget-object v0, p0, Lcom/crashlytics/android/internal/c;->d:Lcom/crashlytics/android/internal/bn;

    invoke-virtual {v0}, Lcom/crashlytics/android/internal/bn;->b()Ljava/lang/String;

    move-result-object v3

    iget-object v0, p0, Lcom/crashlytics/android/internal/c;->d:Lcom/crashlytics/android/internal/bn;

    invoke-virtual {v0}, Lcom/crashlytics/android/internal/bn;->g()Ljava/lang/String;

    move-result-object v4

    iget-object v0, p0, Lcom/crashlytics/android/internal/c;->d:Lcom/crashlytics/android/internal/bn;

    invoke-virtual {v0}, Lcom/crashlytics/android/internal/bn;->c()Ljava/lang/String;

    move-result-object v5

    iget-object v0, p0, Lcom/crashlytics/android/internal/c;->d:Lcom/crashlytics/android/internal/bn;

    invoke-virtual {v0}, Lcom/crashlytics/android/internal/bn;->d()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/crashlytics/android/internal/ck;->c()Landroid/app/Application;
    ...
    iget-object v10, p0, Lcom/crashlytics/android/internal/c;->g:Lcom/crashlytics/android/internal/bt;

    invoke-direct/range {v0 .. v10}, Lcom/crashlytics/android/internal/e;-><init>(Landroid/app/Application;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/crashlytics/android/internal/j;Lcom/crashlytics/android/internal/bt;)V
    ...
    iget-object v2, p0, Lcom/crashlytics/android/internal/c;->g:Lcom/crashlytics/android/internal/bt;
    ...
    invoke-direct/range {v1 .. v10}, Lcom/crashlytics/android/internal/n;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/crashlytics/android/internal/j;Lcom/crashlytics/android/internal/bt;)V
...
.method protected final e()V
    ...
    invoke-direct {v0, v1}, Lcom/crashlytics/android/internal/bt;-><init>(Lcom/crashlytics/android/internal/ch;)V

    iput-object v0, p0, Lcom/crashlytics/android/internal/c;->g:Lcom/crashlytics/android/internal/bt;
    ...
    invoke-virtual {v1, v2}, Lcom/crashlytics/android/internal/ck;->a(Ljava/lang/Class;)Lcom/crashlytics/android/internal/cj;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/crashlytics/android/internal/aj;-><init>(Lcom/crashlytics/android/internal/cj;)V
    ...
    .line 69
    new-instance v2, Lcom/crashlytics/android/internal/bn;

    invoke-direct {v2, v1}, Lcom/crashlytics/android/internal/bn;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/crashlytics/android/internal/c;->d:Lcom/crashlytics/android/internal/bn;
