...
.method constructor <init>(Lokio/e;Ljava/util/zip/Inflater;)V
    ...
    .line 51
    :cond_1
    iput-object p1, p0, Lokio/i;->a:Lokio/e;

    .line 52
    iput-object p2, p0, Lokio/i;->b:Ljava/util/zip/Inflater;

    .line 53
    return-void
.end method

.method public constructor <init>(Lokio/p;Ljava/util/zip/Inflater;)V
    .locals 1
    ...
    invoke-direct {p0, v0, p2}, Lokio/i;-><init>(Lokio/e;Ljava/util/zip/Inflater;)V
...
.method private c()V
    ...
    iget-object v1, p0, Lokio/i;->b:Ljava/util/zip/Inflater;
    ...
    .line 110
    iget-object v1, p0, Lokio/i;->a:Lokio/e;
...
.method public a()Lokio/q;
    ...
    .prologue
    .line 114
    iget-object v0, p0, Lokio/i;->a:Lokio/e;
...
.method public b(Lokio/c;J)J
    ...
    .line 58
    :cond_0
    iget-boolean v2, p0, Lokio/i;->d:Z
    ...
    :try_start_0
    invoke-virtual {p1, v1}, Lokio/c;->d(I)Lokio/m;

    move-result-object v1

    .line 67
    iget-object v2, p0, Lokio/i;->b:Ljava/util/zip/Inflater;

    iget-object v3, v1, Lokio/m;->a:[B

    iget v4, v1, Lokio/m;->c:I

    iget v5, v1, Lokio/m;->c:I
...
.method public b()Z
    ...
    invoke-interface {v1}, Lokio/e;->d()Lokio/c;

    move-result-object v1

    iget-object v1, v1, Lokio/c;->a:Lokio/m;
...
.method public close()V
    ...
    .line 119
    :cond_0
    iget-object v0, p0, Lokio/i;->b:Ljava/util/zip/Inflater;
