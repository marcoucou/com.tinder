  ...
  implements X509TrustManager
{
    ...
    throws CertificateException
  {
    ...
    {
      ck.a().b().c("Crashlytics", "Certificate pins are stale, (" + (System.currentTimeMillis() - c) + " millis vs 15552000000" + " millis) falling back to system trust.");
      e.add(paramArrayOfX509Certificate[0]);
      return;
    }
    paramString = bt.a(paramArrayOfX509Certificate, b);
