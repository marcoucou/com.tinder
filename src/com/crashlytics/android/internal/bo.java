  ...
  implements Closeable
{
    ...
    throws IOException
  {
    ...
    b.seek(paramInt);
    return new bq(paramInt, b.readInt());
  }
    ...
    throws IOException
  {
    ...
    {
      paramInt1 = 16;
      localbq = new bq(paramInt1, paramInt2);
      a(g, 0, paramInt2);
      a(b, g, 0, 4);
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      {
        bq localbq = a(j);
        parambs.a(new br(this, localbq, (byte)0), c);
        j = b;
        j = b(c + (j + 4));
        i += 1;
      }
  ...
  public final boolean b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 125	com/crashlytics/android/internal/bo:d	I
    //   6: istore_1
    //   7: iload_1
    //   8: ifne +9 -> 17
    //   11: iconst_1
  ...
  public String toString()
  {
    ...
    try
    {
      a(new bp(this, localStringBuilder));
