...
public class bt
{
  ...
  private SSLSocketFactory b()
  {
    ...
    //   2: aload_0
    //   3: iconst_1
    //   4: putfield 30	com/crashlytics/android/internal/bt:d	Z
    //   7: aload_0
    //   8: getfield 97	com/crashlytics/android/internal/bt:b	Lcom/crashlytics/android/internal/af;
    //   11: astore_1
    //   12: ldc 99
    ...
    //   24: dup
    //   25: iconst_0
    //   26: new 109	com/crashlytics/android/internal/ag
    //   29: dup
    //   30: new 66	com/crashlytics/android/internal/ah
    //   33: dup
    //   34: aload_1
    //   35: invokeinterface 114 1 0
    //   40: aload_1
    //   41: invokeinterface 117 1 0
    //   46: invokespecial 120	com/crashlytics/android/internal/ah:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   49: aload_1
    //   50: invokespecial 123	com/crashlytics/android/internal/ag:<init>	(Lcom/crashlytics/android/internal/ah;Lcom/crashlytics/android/internal/af;)V
    //   53: aastore
    //   54: aconst_null
    ...
    //   62: astore_1
    //   63: aload_0
    //   64: getfield 25	com/crashlytics/android/internal/bt:a	Lcom/crashlytics/android/internal/ch;
    //   67: ldc -124
    //   69: ldc -122
    ...
    //   80: astore_1
    //   81: aload_0
    //   82: getfield 25	com/crashlytics/android/internal/bt:a	Lcom/crashlytics/android/internal/ch;
    //   85: ldc -124
    //   87: ldc -115
    //   89: aload_1
  ...
  public bv a(ax paramax, String paramString, Map<String, String> paramMap)
  {
    switch (bu.a[paramax.ordinal()])
    {
    default: 
      throw new IllegalArgumentException("Unsupported HTTP method!");
    case 1: 
      paramax = bv.a(paramString, paramMap, true);
      if (paramString != null) {
        break;
      }
    }
    for (boolean bool = false;; bool = paramString.toLowerCase().startsWith("https"))
    {
      ...
      return paramax;
      paramax = bv.b(paramString, paramMap, true);
      break;
      paramax = bv.a(paramString);
      break;
      paramax = bv.b(paramString);
      break;
    }
  }
}
...
/* Location:
 * Qualified Name:     com.crashlytics.android.internal.bt
