...
public final class bn
{
  ...
  public bn(Context paramContext)
  {
    ...
    if (!d) {
      ck.a().b().a("Crashlytics", "Device ID collection disabled for " + paramContext.getPackageName());
    }
    e = bd.a(paramContext, "com.crashlytics.CollectUserIdentifiers", true);
    if (!e) {
      ck.a().b().a("Crashlytics", "User information collection disabled for " + paramContext.getPackageName());
    }
  }
  ...
  private String i()
  {
    if ((d) && (Build.VERSION.SDK_INT >= 9)) {
      ...
      {
        ck.a().b().a("Crashlytics", "Could not retrieve android.os.Build.SERIAL value", localException);
      }
    }
    return null;
  }
  ...
  public final String h()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ck.a().b().a("Crashlytics", "Utils#getBluetoothMacAddress failed, returning null. Requires prior call to BluetoothAdatpter.getDefaultAdapter() on thread that has called Looper.prepare()", localException);
      }
    }
    return null;
  }
