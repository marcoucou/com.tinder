  ...
  public static String a(Context paramContext, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        Object localObject1;
        int i;
        cn.a().b().a("Crashlytics", "Caught non-fatal exception while retrieving apiKey: " + localException);
        label133:
        Object localObject2 = null;
      }
      cn.a().b().a("Crashlytics", "Crashlytics could not be initialized, API key missing from AndroidManifest.xml. Add the following tag to your Application element \n\t<meta-data android:name=\"com.crashlytics.ApiKey\" android:value=\"YOUR_API_KEY\"/>", null);
    }
...
/* Location:
 * Qualified Name:     com.crashlytics.android.internal.ci
