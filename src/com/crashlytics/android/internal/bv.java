...
public final class bv
{
  ...
  private bv(CharSequence paramCharSequence, String paramString)
    throws aD
  {
    try
    {
  ...
  private bv a(InputStream paramInputStream, OutputStream paramOutputStream)
    throws IOException
  {
    return (bv)new bw(this, paramInputStream, g, paramInputStream, paramOutputStream).call();
  }
  
  public static bv a(CharSequence paramCharSequence)
    throws aD
  {
    return new bv(paramCharSequence, "PUT");
  }
  
  public static bv a(CharSequence paramCharSequence, Map<?, ?> paramMap, boolean paramBoolean)
  {
    return new bv(c(a(paramCharSequence, paramMap)), "GET");
  }
  
  private bv a(String paramString1, String paramString2, String paramString3)
    throws IOException
  {
  ...
  private bv a(String paramString1, String paramString2, String paramString3, String paramString4)
    throws aD
  {
    try
    {
  ...
  public static bv b(CharSequence paramCharSequence)
    throws aD
  {
    return new bv(paramCharSequence, "DELETE");
  }
  
  public static bv b(CharSequence paramCharSequence, Map<?, ?> paramMap, boolean paramBoolean)
  {
    return new bv(c(a(paramCharSequence, paramMap)), "POST");
  }
  
  private bv b(String paramString1, String paramString2, String paramString3)
    throws aD
  {
  ...
  private bv d(CharSequence paramCharSequence)
    throws aD
  {
    try
    {
  ...
  private bv d(String paramString1, String paramString2)
    throws aD
  {
  ...
  public final bv a(int paramInt)
  {
    a().setConnectTimeout(10000);
    return this;
  }
  
  public final bv a(String paramString, Number paramNumber)
    throws aD
  {
    if (paramNumber != null) {}
  ...
  public final bv a(String paramString1, String paramString2)
  {
  ...
  /* Error */
  public final bv a(String paramString1, String paramString2, String paramString3, java.io.File paramFile)
    throws aD
  {
    // Byte code:
    ...
    //   25: aload_3
    //   26: aload 5
    //   28: invokevirtual 369	com/crashlytics/android/internal/bv:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Lcom/crashlytics/android/internal/bv;
    //   31: astore_1
    //   32: aload 5
  ...
  public final bv a(String paramString1, String paramString2, String paramString3, InputStream paramInputStream)
    throws aD
  {
    try
    {
  ...
  public final bv a(Map.Entry<String, String> paramEntry)
  {
    return a((String)paramEntry.getKey(), (String)paramEntry.getValue());
  }
  
  public final bv a(boolean paramBoolean)
  {
  ...
  public final bv b(String paramString1, String paramString2)
  {
...
/* Location:
 * Qualified Name:     com.crashlytics.android.internal.bv
