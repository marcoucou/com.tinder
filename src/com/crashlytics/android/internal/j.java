...
final class j
{
  ...
  private final bi d;
  private final int e;
  private List<bj> f = new CopyOnWriteArrayList();
  
  j(v paramv, bh parambh, bi parambi)
    throws IOException
  {
    this(paramv, parambh, parambi, 100);
  }
  
  private j(v paramv, bh parambh, bi parambi, int paramInt)
    throws IOException
  {
    a = paramv;
    d = parambi;
  ...
  private void a(String paramString)
  {
    ...
    {
      bj localbj = (bj)paramString.next();
      try
      {
        localbj.c();
      }
      ...
      {
        ck.a().b().a("Crashlytics", "One of the roll over listeners threw an exception", localException);
      }
    }
  }
