  ...
  implements Flushable
{
  ...
  private ap(OutputStream paramOutputStream, byte[] paramArrayOfByte)
  {
    d = paramOutputStream;
    a = paramArrayOfByte;
    c = 0;
  ...
  {
    return c(ai.a(paramInt, 0));
  }
  
  public static ap a(OutputStream paramOutputStream)
  {
    return new ap(paramOutputStream, new byte['က']);
  }
  ...
  public static int b(int paramInt, al paramal)
  {
    return a(paramInt) + (c(paramal.a()) + paramal.a());
  }
