...
final class al
{
  ...
  private al(byte[] paramArrayOfByte)
  {
    a = paramArrayOfByte;
  }
  ...
  public static al a(String paramString)
  {
    try
    {
      paramString = new al(paramString.getBytes("UTF-8"));
      return paramString;
    }
  ...
  public static al a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    byte[] arrayOfByte = new byte[paramInt2];
    System.arraycopy(paramArrayOfByte, 0, arrayOfByte, 0, paramInt2);
    return new al(arrayOfByte);
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (al)paramObject;
      int j = a.length;
      if (j != a.length) {
        return false;
      }
