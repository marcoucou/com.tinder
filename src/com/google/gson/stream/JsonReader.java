  ...
  implements Closeable
{
  ...
  static
  {
    com.google.gson.internal.d.INSTANCE = new com.google.gson.internal.d()
    {
      public void promoteNameToValue(JsonReader paramAnonymousJsonReader)
        throws IOException
      {
        if ((paramAnonymousJsonReader instanceof com.google.gson.internal.a.d))
        {
          ((com.google.gson.internal.a.d)paramAnonymousJsonReader).a();
          return;
        }
        int j = peeked;
        int i = j;
