...
public final class a
{
  ...
  static void e(Context paramContext)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 295	com/google/android/gcm/a:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
    //   6: ifnonnull +89 -> 95
    //   9: getstatic 207	com/google/android/gcm/a:b	Ljava/lang/String;
    //   12: ifnonnull +87 -> 99
    //   15: ldc 29
    //   17: ldc_w 297
    //   20: invokestatic 299	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   23: pop
    //   24: new 301	com/google/android/gcm/GCMBroadcastReceiver
    //   27: dup
    //   28: invokespecial 302	com/google/android/gcm/GCMBroadcastReceiver:<init>	()V
    //   31: putstatic 295	com/google/android/gcm/a:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
    //   34: aload_0
    //   35: invokevirtual 126	android/content/Context:getPackageName	()Ljava/lang/String;
    //   38: astore_2
    //   39: new 304	android/content/IntentFilter
    //   42: dup
    //   43: ldc_w 306
    //   46: invokespecial 307	android/content/IntentFilter:<init>	(Ljava/lang/String;)V
    //   49: astore_1
    //   50: aload_1
    //   51: aload_2
    //   52: invokevirtual 310	android/content/IntentFilter:addCategory	(Ljava/lang/String;)V
    ...
    //   83: pop
    //   84: aload_0
    //   85: getstatic 295	com/google/android/gcm/a:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
    //   88: aload_1
    //   89: aload_2
    //   90: aconst_null
    //   91: invokevirtual 316	android/content/Context:registerReceiver	(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    //   94: pop
    //   95: ldc 2
    //   97: monitorexit
    //   98: return
    //   99: getstatic 207	com/google/android/gcm/a:b	Ljava/lang/String;
    //   102: invokestatic 322	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   105: invokevirtual 325	java/lang/Class:newInstance	()Ljava/lang/Object;
    //   108: checkcast 301	com/google/android/gcm/GCMBroadcastReceiver
    //   111: putstatic 295	com/google/android/gcm/a:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
    //   114: goto -80 -> 34
    //   117: astore_1
    //   118: ldc 29
    ...
    //   133: getstatic 207	com/google/android/gcm/a:b	Ljava/lang/String;
    ...
    //   145: ldc_w 301
    //   148: invokevirtual 332	java/lang/Class:getName	()Ljava/lang/String;
    ...
    //   163: invokestatic 299	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   166: pop
    //   167: new 301	com/google/android/gcm/GCMBroadcastReceiver
    //   170: dup
    //   171: invokespecial 302	com/google/android/gcm/GCMBroadcastReceiver:<init>	()V
    //   174: putstatic 295	com/google/android/gcm/a:a	Lcom/google/android/gcm/GCMBroadcastReceiver;
    //   177: goto -143 -> 34
    //   180: astore_0
    //   181: ldc 2
    //   183: monitorexit
