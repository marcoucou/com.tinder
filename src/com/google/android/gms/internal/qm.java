  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      do
      {
        return bool1;
        bool1 = bool2;
      } while (!(paramObject instanceof qm));
      paramObject = (qm)paramObject;
      bool1 = bool2;
    } while (!qu.equals(ayq, ayq));
    return a((qq)paramObject);
  }
  
  public int hashCode()
  {
    return (qu.hashCode(ayq) + 527) * 31 + rQ();
  }
    ...
    throws IOException
  {
    for (;;)
    {
      ...
      case 10: 
        ...
        if (ayq == null) {}
        a[] arrayOfa;
        for (i = 0;; i = ayq.length)
        {
          arrayOfa = new a[j + i];
          j = i;
          if (i != 0)
          {
            System.arraycopy(ayq, 0, arrayOfa, 0, i);
            j = i;
          }
          while (j < arrayOfa.length - 1)
          {
            arrayOfa[j] = new a();
            paramqo.a(arrayOfa[j]);
            paramqo.rz();
            j += 1;
          }
        }
