...
public class DataMap
{
  ...
  public static DataMap fromByteArray(byte[] paramArrayOfByte)
  {
    try
    {
      paramArrayOfByte = ql.a(new ql.a(qm.n(paramArrayOfByte), new ArrayList()));
  ...
  {
    return axg.containsKey(paramString);
  }
  ...
  {
    return (T)axg.get(paramString);
  }
  
  public Asset getAsset(String paramString)
  {
    Object localObject = axg.get(paramString);
    if (localObject == null) {
      return null;
    }
    try
  ...
  {
    axg.put(paramString, Long.valueOf(paramLong));
  }
  
  public void putLongArray(String paramString, long[] paramArrayOfLong)
  {
    axg.put(paramString, paramArrayOfLong);
  }
  
  public void putString(String paramString1, String paramString2)
  {
    axg.put(paramString1, paramString2);
  }
  
  public void putStringArray(String paramString, String[] paramArrayOfString)
  {
    axg.put(paramString, paramArrayOfString);
  }
  ...
  public Bundle toBundle()
  {
    ...
    Iterator localIterator = axg.keySet().iterator();
    while (localIterator.hasNext())
    {
      String str = (String)localIterator.next();
      a(localBundle, str, axg.get(str));
    }
    return localBundle;
  }
