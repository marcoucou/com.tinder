...
public final class b
{
  ...
  private b(n paramn, p paramp)
  {
    a = paramn;
    b = paramp;
  }
  
  public static boolean a(p paramp, n paramn)
  {
    int i = paramp.c();
    ...
    do
    {
      return false;
      paramp = paramp.m();
    } while (((paramn.a("Authorization") != null) && (!paramp.e()) && (!paramp.f()) && (paramp.d() == -1)) || (paramp.b()));
    return true;
  }
  ...
  public static class a
  {
    ...
    public a(long paramLong, n paramn, p paramp)
    {
      a = paramLong;
      b = paramn;
      c = paramp;
