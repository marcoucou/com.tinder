...
public class l
{
  ...
  private static String e(String paramString, Object... paramVarArgs)
  {
    ...
    if (paramVarArgs == null)
    {
      ...
      if (paramVarArgs[i].getClass().equals(l.class)) {
        break label147;
      }
  ...
  static class a
  {
    ...
    public void a(String paramString)
    {
      ...
      //   2: aload_0
      //   3: iconst_1
      //   4: putfield 31	com/android/volley/l$a:c	Z
      //   7: aload_0
      //   8: invokespecial 48	com/android/volley/l$a:a	()J
      //   11: lstore 4
      //   13: lload 4
      //   15: lconst_0
      //   16: lcmp
      ...
      //   22: return
      //   23: aload_0
      //   24: getfield 29	com/android/volley/l$a:b	Ljava/util/List;
      //   27: iconst_0
      //   28: invokeinterface 42 2 0
      //   33: checkcast 9	com/android/volley/l$a$a
      //   36: getfield 45	com/android/volley/l$a$a:c	J
      //   39: lstore_2
      //   40: ldc 50
      //   42: iconst_2
      ...
      //   56: aload_1
      //   57: aastore
      //   58: invokestatic 59	com/android/volley/l:b	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   61: aload_0
      //   62: getfield 29	com/android/volley/l$a:b	Ljava/util/List;
      ...
      //   86: checkcast 9	com/android/volley/l$a$a
      //   89: astore 6
      //   91: aload 6
      //   93: getfield 45	com/android/volley/l$a$a:c	J
      //   96: lstore 4
      //   98: ldc 75
      //   100: iconst_3
      ...
      //   115: iconst_1
      //   116: aload 6
      //   118: getfield 77	com/android/volley/l$a$a:b	J
      //   121: invokestatic 56	java/lang/Long:valueOf	(J)Ljava/lang/Long;
      //   124: aastore
      //   125: dup
      //   126: iconst_2
      //   127: aload 6
      //   129: getfield 80	com/android/volley/l$a$a:a	Ljava/lang/String;
      //   132: aastore
      //   133: invokestatic 59	com/android/volley/l:b	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   136: lload 4
      //   138: lstore_2
      //   139: goto -68 -> 71
      //   142: astore_1
