  ...
  implements FacebookDialog.OnPresentCallback
{
    ...
    throws Exception
  {
    ...
    if ((this$0.imageAttachmentFiles != null) && (this$0.imageAttachmentFiles.size() > 0)) {
      FacebookDialog.access$900().addAttachmentFilesForCall(paramContext, this$0.appCall.getCallId(), this$0.imageAttachmentFiles);
    }
  }
}
