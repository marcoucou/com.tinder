  ...
  extends FrameLayout
{
  ...
  private void parseAttributes(AttributeSet paramAttributeSet)
  {
    ...
    isCropped = paramAttributeSet.getBoolean(1, true);
  ...
  private void sendImageRequest(boolean paramBoolean)
  {
    try
    {
      ImageRequest localImageRequest = new ImageRequest.Builder(getContext(), ImageRequest.getProfilePictureUrl(profileId, queryWidth, queryHeight)).setAllowCachedRedirects(paramBoolean).setCallerTag(this).setCallback(new ImageRequest.Callback()
      {
