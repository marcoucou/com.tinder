...
class AppEventsLogger$PersistedAppSessionInfo
{
  ...
  private static void restoreAppSessionInformation(Context paramContext)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: getstatic 30	com/facebook/AppEventsLogger$PersistedAppSessionInfo:staticLock	Ljava/lang/Object;
    //   5: astore 5
    //   7: aload 5
    //   9: monitorenter
    //   10: getstatic 34	com/facebook/AppEventsLogger$PersistedAppSessionInfo:isLoaded	Z
    //   13: istore_1
    //   14: iload_1
    //   15: ifne +76 -> 91
    ...
    //   41: putstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   44: aload_2
    //   45: astore_3
    ...
    //   66: pop
    //   67: getstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   70: ifnonnull +13 -> 83
    //   73: new 113	java/util/HashMap
    //   76: dup
    //   77: invokespecial 140	java/util/HashMap:<init>	()V
    //   80: putstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   83: iconst_1
    //   84: putstatic 34	com/facebook/AppEventsLogger$PersistedAppSessionInfo:isLoaded	Z
    //   87: iconst_0
    //   88: putstatic 32	com/facebook/AppEventsLogger$PersistedAppSessionInfo:hasChanges	Z
    //   91: aload 5
    //   93: monitorexit
    //   94: return
    //   95: aload_2
    ...
    //   105: pop
    //   106: getstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   109: ifnonnull +13 -> 122
    //   112: new 113	java/util/HashMap
    //   115: dup
    //   116: invokespecial 140	java/util/HashMap:<init>	()V
    //   119: putstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   122: iconst_1
    //   123: putstatic 34	com/facebook/AppEventsLogger$PersistedAppSessionInfo:isLoaded	Z
    //   126: iconst_0
    //   127: putstatic 32	com/facebook/AppEventsLogger$PersistedAppSessionInfo:hasChanges	Z
    //   130: goto -39 -> 91
    //   133: astore_0
    //   134: aload 5
    //   136: monitorexit
    ...
    //   143: aload_2
    //   144: astore_3
    //   145: invokestatic 144	com/facebook/AppEventsLogger:access$1300	()Ljava/lang/String;
    ...
    //   160: aload 4
    //   162: invokevirtual 156	java/lang/Exception:toString	()Ljava/lang/String;
    //   165: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   168: invokevirtual 157	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   171: invokestatic 163	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   174: pop
    //   175: aload_2
    //   176: invokestatic 135	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   179: aload_0
    //   180: ldc 13
    //   182: invokevirtual 139	android/content/Context:deleteFile	(Ljava/lang/String;)Z
    //   185: pop
    //   186: getstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   189: ifnonnull +13 -> 202
    //   192: new 113	java/util/HashMap
    //   195: dup
    //   196: invokespecial 140	java/util/HashMap:<init>	()V
    //   199: putstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   202: iconst_1
    //   203: putstatic 34	com/facebook/AppEventsLogger$PersistedAppSessionInfo:isLoaded	Z
    //   206: iconst_0
    //   207: putstatic 32	com/facebook/AppEventsLogger$PersistedAppSessionInfo:hasChanges	Z
    //   210: goto -119 -> 91
    //   213: aload_3
    //   214: invokestatic 135	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   217: aload_0
    //   218: ldc 13
    //   220: invokevirtual 139	android/content/Context:deleteFile	(Ljava/lang/String;)Z
    //   223: pop
    //   224: getstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   227: ifnonnull +13 -> 240
    //   230: new 113	java/util/HashMap
    //   233: dup
    //   234: invokespecial 140	java/util/HashMap:<init>	()V
    //   237: putstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   240: iconst_1
    //   241: putstatic 34	com/facebook/AppEventsLogger$PersistedAppSessionInfo:isLoaded	Z
    //   244: iconst_0
    //   245: putstatic 32	com/facebook/AppEventsLogger$PersistedAppSessionInfo:hasChanges	Z
    //   248: aload_2
    //   249: athrow
    //   250: astore_2
    //   251: goto -38 -> 213
  ...
  {
    // Byte code:
    //   0: getstatic 30	com/facebook/AppEventsLogger$PersistedAppSessionInfo:staticLock	Ljava/lang/Object;
    //   3: astore 4
    //   5: aload 4
    //   7: monitorenter
    //   8: getstatic 32	com/facebook/AppEventsLogger$PersistedAppSessionInfo:hasChanges	Z
    //   11: istore_1
    //   12: iload_1
    //   13: ifeq +56 -> 69
    //   16: new 166	java/io/ObjectOutputStream
    //   19: dup
    //   20: new 168	java/io/BufferedOutputStream
    //   23: dup
    //   24: aload_0
    //   25: ldc 13
    //   27: iconst_0
    //   28: invokevirtual 172	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   31: invokespecial 175	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   34: invokespecial 176	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   37: astore_2
    //   38: aload_2
    //   39: astore_0
    //   40: aload_2
    //   41: getstatic 46	com/facebook/AppEventsLogger$PersistedAppSessionInfo:appSessionInfoMap	Ljava/util/Map;
    //   44: invokevirtual 180	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   47: aload_2
    //   48: astore_0
    //   49: iconst_0
    //   50: putstatic 32	com/facebook/AppEventsLogger$PersistedAppSessionInfo:hasChanges	Z
    //   53: aload_2
    //   54: astore_0
    ...
    //   76: aload_2
    //   77: astore_0
    //   78: invokestatic 144	com/facebook/AppEventsLogger:access$1300	()Ljava/lang/String;
    ...
    //   122: astore_0
    //   123: aload_0
    //   124: invokestatic 135	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   127: aload_2
    //   128: athrow
    //   129: astore_2
    //   130: goto -7 -> 123
