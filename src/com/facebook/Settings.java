...
public final class Settings
{
  ...
  public static String getApplicationSignature(Context paramContext)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokevirtual 182	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull -8 -> 4
    //   15: aload_0
    //   16: invokevirtual 185	android/content/Context:getPackageName	()Ljava/lang/String;
    //   19: astore_0
    //   20: aload_1
    //   21: aload_0
    //   22: bipush 64
    //   24: invokevirtual 191	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   27: astore_0
    //   28: aload_0
    //   29: getfield 197	android/content/pm/PackageInfo:signatures	[Landroid/content/pm/Signature;
    //   32: astore_1
    //   33: aload_1
    //   34: ifnull -30 -> 4
    //   37: aload_1
    ...
    //   39: ifeq -35 -> 4
    //   42: ldc -57
    //   44: invokestatic 205	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   47: astore_1
    //   48: aload_1
    //   49: aload_0
    //   50: getfield 197	android/content/pm/PackageInfo:signatures	[Landroid/content/pm/Signature;
    //   53: iconst_0
    //   54: aaload
    //   55: invokevirtual 211	android/content/pm/Signature:toByteArray	()[B
    //   58: invokevirtual 215	java/security/MessageDigest:update	([B)V
    //   61: aload_1
    //   62: invokevirtual 218	java/security/MessageDigest:digest	()[B
    //   65: bipush 9
    //   67: invokestatic 224	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    //   70: areturn
    //   71: astore_0
    //   72: aconst_null
    //   73: areturn
  ...
  static void publishInstallAsync(Context paramContext, final String paramString, final Request.Callback paramCallback)
  {
    ...
    getExecutor().execute(new Runnable()
    {
      public void run()
      {
        final Response localResponse = Settings.publishInstallAndWaitForResponse(val$applicationContext, paramString, false);
