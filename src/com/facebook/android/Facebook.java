...
public class Facebook
{
    ...
    extends TokenCachingStrategy
  {
    ...
    public Bundle load()
    {
      ...
      if (accessToken != null)
      {
        TokenCachingStrategy.putToken(localBundle, accessToken);
        TokenCachingStrategy.putExpirationMilliseconds(localBundle, accessExpiresMillisecondsAfterEpoch);
        TokenCachingStrategy.putPermissions(localBundle, Facebook.stringList(pendingAuthorizationPermissions));
        TokenCachingStrategy.putSource(localBundle, AccessTokenSource.WEB_VIEW);
        TokenCachingStrategy.putLastRefreshMilliseconds(localBundle, lastAccessUpdateMillisecondsAfterEpoch);
      }
      return localBundle;
    }
    ...
    implements ServiceConnection
  {
    ...
    {
      Bundle localBundle = new Bundle();
      localBundle.putString("access_token", accessToken);
