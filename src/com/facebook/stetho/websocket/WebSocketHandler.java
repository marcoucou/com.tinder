  ...
  extends SecureHttpRequestHandler
{
    ...
    throws IOException, HttpException
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 188	com/facebook/stetho/websocket/WebSocketHandler:isSupportableUpgradeRequest	(Lorg/apache/http/HttpRequest;)Z
    //   4: ifne +36 -> 40
    //   7: aload_2
    //   8: sipush 501
    ...
    //   24: aload_2
    //   25: new 192	org/apache/http/entity/StringEntity
    //   28: dup
    //   29: ldc -62
    //   31: invokespecial 196	org/apache/http/entity/StringEntity:<init>	(Ljava/lang/String;)V
    //   34: invokeinterface 200 2 0
    //   39: return
    //   40: aload_3
    //   41: ldc -54
    //   43: invokeinterface 208 2 0
    //   48: checkcast 210	org/apache/http/HttpConnection
    //   51: astore 4
    //   53: aload_0
    //   54: aload_1
    //   55: aload_2
    //   56: aload_3
    //   57: invokespecial 212	com/facebook/stetho/websocket/WebSocketHandler:doUpgrade	(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)V
    //   60: aload 4
    //   62: invokeinterface 215 1 0
    //   67: new 217	org/apache/http/ConnectionClosedException
    //   70: dup
    //   71: ldc -37
    //   73: invokespecial 220	org/apache/http/ConnectionClosedException:<init>	(Ljava/lang/String;)V
    //   76: athrow
    //   77: astore_1
    //   78: aload 4
    //   80: invokeinterface 215 1 0
    //   85: aload_1
    //   86: athrow
    //   87: astore_1
    //   88: goto -21 -> 67
