  ...
  implements Serializable
{
  ...
  private void logAuthorizationComplete(AuthorizationClient.Result.Code paramCode, Map<String, String> paramMap, Exception paramException)
  {
    ...
    for (paramCode = new JSONObject(pendingAuthorizationRequest.loggingExtras);; paramCode = null)
    {
    ...
    localRequest.setCallback(new Request.Callback()
    {
      public void onCompleted(Response arg1)
      {
        ...
        if (localPermissionsPair != null) {
          synchronized (lock)
          {
            Session.access$302(Session.this, AccessToken.createFromTokenWithRefreshedPermissions(tokenInfo, localPermissionsPair.getGrantedPermissions(), localPermissionsPair.getDeclinedPermissions()));
