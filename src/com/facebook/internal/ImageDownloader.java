...
public class ImageDownloader
{
  ...
  private static void download(RequestKey paramRequestKey, Context paramContext)
  {
    ...
    //   14: iconst_1
    //   15: istore_2
    //   16: new 114	java/net/URL
    //   19: dup
    //   20: aload_0
    //   21: getfield 118	com/facebook/internal/ImageDownloader$RequestKey:uri	Ljava/net/URI;
    //   24: invokevirtual 124	java/net/URI:toString	()Ljava/lang/String;
    //   27: invokespecial 127	java/net/URL:<init>	(Ljava/lang/String;)V
    //   30: invokevirtual 131	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   33: checkcast 133	java/net/HttpURLConnection
    //   36: astore 6
    //   38: aload 6
    //   40: iconst_0
    //   41: invokevirtual 137	java/net/HttpURLConnection:setInstanceFollowRedirects	(Z)V
    //   44: aload 6
    //   46: invokevirtual 141	java/net/HttpURLConnection:getResponseCode	()I
    //   49: lookupswitch	default:+540->589, 200:+297->346, 301:+196->245, 302:+196->245
    //   84: aload 6
    //   86: invokevirtual 145	java/net/HttpURLConnection:getErrorStream	()Ljava/io/InputStream;
    //   89: astore 7
    //   91: aload 7
    //   93: astore 8
    //   95: aload 7
    ...
    //   99: aload 7
    //   101: astore 10
    //   103: new 147	java/lang/StringBuilder
    //   106: dup
    //   107: invokespecial 148	java/lang/StringBuilder:<init>	()V
    //   110: astore 13
    //   112: aload 7
    //   114: ifnull +347 -> 461
    //   117: aload 7
    ...
    //   125: aload 7
    //   127: astore 10
    //   129: new 150	java/io/InputStreamReader
    //   132: dup
    //   133: aload 7
    //   135: invokespecial 153	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   138: astore_1
    //   139: aload 7
    //   141: astore 8
    //   143: aload 7
    ...
    //   174: aload 14
    //   176: arraylength
    //   177: invokevirtual 157	java/io/InputStreamReader:read	([CII)I
    //   180: istore 5
    //   182: iload 5
    //   184: ifle +196 -> 380
    //   187: aload 7
    ...
    //   203: iconst_0
    //   204: iload 5
    //   206: invokevirtual 161	java/lang/StringBuilder:append	([CII)Ljava/lang/StringBuilder;
    //   209: pop
    //   210: goto -52 -> 158
    //   213: astore_1
    //   214: aload 8
    //   216: astore 7
    //   218: aload 7
    //   220: invokestatic 167	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   223: aload 6
    //   225: invokestatic 171	com/facebook/internal/Utility:disconnectQuietly	(Ljava/net/URLConnection;)V
    //   228: aload 11
    //   230: astore 9
    //   232: iload_2
    //   233: ifeq +11 -> 244
    ...
    //   238: aload 9
    //   240: iconst_0
    //   241: invokestatic 175	com/facebook/internal/ImageDownloader:issueResponse	(Lcom/facebook/internal/ImageDownloader$RequestKey;Ljava/lang/Exception;Landroid/graphics/Bitmap;Z)V
    //   244: return
    //   245: aload 6
    //   247: ldc -79
    //   249: invokevirtual 181	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   252: astore 7
    //   254: aload 7
    //   256: invokestatic 185	com/facebook/internal/Utility:isNullOrEmpty	(Ljava/lang/String;)Z
    //   259: ifne +316 -> 575
    //   262: new 120	java/net/URI
    //   265: dup
    //   266: aload 7
    //   268: invokespecial 186	java/net/URI:<init>	(Ljava/lang/String;)V
    //   271: astore 7
    //   273: aload_1
    //   274: aload_0
    //   275: getfield 118	com/facebook/internal/ImageDownloader$RequestKey:uri	Ljava/net/URI;
    //   278: aload 7
    //   280: invokestatic 190	com/facebook/internal/UrlRedirectCache:cacheUriRedirect	(Landroid/content/Context;Ljava/net/URI;Ljava/net/URI;)V
    //   283: aload_0
    //   284: invokestatic 194	com/facebook/internal/ImageDownloader:removePendingRequest	(Lcom/facebook/internal/ImageDownloader$RequestKey;)Lcom/facebook/internal/ImageDownloader$DownloaderContext;
    //   287: astore_1
    //   288: aload_1
    //   289: ifnull +31 -> 320
    //   292: aload_1
    ...
    //   296: ifne +24 -> 320
    //   299: aload_1
    //   300: getfield 198	com/facebook/internal/ImageDownloader$DownloaderContext:request	Lcom/facebook/internal/ImageRequest;
    //   303: new 17	com/facebook/internal/ImageDownloader$RequestKey
    //   306: dup
    //   307: aload 7
    //   309: aload_0
    //   310: getfield 202	com/facebook/internal/ImageDownloader$RequestKey:tag	Ljava/lang/Object;
    //   313: invokespecial 76	com/facebook/internal/ImageDownloader$RequestKey:<init>	(Ljava/net/URI;Ljava/lang/Object;)V
    //   316: iconst_0
    //   317: invokestatic 206	com/facebook/internal/ImageDownloader:enqueueCacheRead	(Lcom/facebook/internal/ImageRequest;Lcom/facebook/internal/ImageDownloader$RequestKey;Z)V
    //   320: iconst_0
    //   321: istore_2
    //   322: aconst_null
    //   323: astore 8
    ...
    //   329: astore 9
    //   331: aload_1
    //   332: invokestatic 167	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   335: aload 6
    //   337: invokestatic 171	com/facebook/internal/Utility:disconnectQuietly	(Ljava/net/URLConnection;)V
    //   340: aload 8
    //   342: astore_1
    //   343: goto -111 -> 232
    //   346: aload_1
    //   347: aload 6
    //   349: invokestatic 210	com/facebook/internal/ImageResponseCache:interceptAndCacheImageStream	(Landroid/content/Context;Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    //   352: astore_1
    //   353: aload_1
    //   354: astore 8
    //   356: aload_1
    ...
    //   360: astore 10
    //   362: aload_1
    //   363: invokestatic 216	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   366: astore 7
    //   368: aconst_null
    //   369: astore 8
    //   371: aload 7
    ...
    //   390: astore 10
    //   392: aload_1
    //   393: invokestatic 167	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   396: aload 7
    //   398: astore 8
    //   400: aload 7
    //   402: astore 9
    //   404: aload 7
    //   406: astore 10
    //   408: new 218	com/facebook/FacebookException
    //   411: dup
    //   412: aload 13
    //   414: invokevirtual 219	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   417: invokespecial 220	com/facebook/FacebookException:<init>	(Ljava/lang/String;)V
    //   420: astore_1
    //   421: iload_3
    //   422: istore_2
    //   423: aload 12
    ...
    //   443: istore_2
    //   444: aload 7
    //   446: invokestatic 167	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   449: aload 6
    //   451: invokestatic 171	com/facebook/internal/Utility:disconnectQuietly	(Ljava/net/URLConnection;)V
    //   454: aload 11
    //   456: astore 9
    //   458: goto -226 -> 232
    //   461: aload 7
    ...
    //   473: aload 13
    //   475: aload_1
    //   476: getstatic 225	com/facebook/android/R$string:com_facebook_image_download_unknown_error	I
    //   479: invokevirtual 231	android/content/Context:getString	(I)Ljava/lang/String;
    //   482: invokevirtual 234	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   485: pop
    //   486: goto -90 -> 396
    //   489: astore_0
    //   490: aload 6
    //   492: astore_1
    //   493: aload 10
    //   495: invokestatic 167	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   498: aload_1
    //   499: invokestatic 171	com/facebook/internal/Utility:disconnectQuietly	(Ljava/net/URLConnection;)V
    //   502: aload_0
    //   503: athrow
    //   504: astore_0
    //   505: aconst_null
    ...
    //   0	592	0	paramRequestKey	RequestKey
