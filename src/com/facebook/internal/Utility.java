...
public final class Utility
{
  ...
  public static void loadAppSettingsAsync(final Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      initialAppSettingsLoadTask = new AsyncTask()
      {
        ...
        {
          return Utility.getAppSettingsQueryResponse(val$applicationId);
        }
        ...
        protected void onPostExecute(GraphObject paramAnonymousGraphObject)
        {
          if (paramAnonymousGraphObject != null)
          {
            ...
            Utility.parseAppSettingsFromJSON(val$applicationId, paramAnonymousGraphObject);
            paramContext.getSharedPreferences("com.facebook.internal.preferences.APP_SETTINGS", 0).edit().putString(str, paramAnonymousGraphObject.toString()).apply();
          }
    ...
    throws IOException
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 673	java/io/BufferedInputStream
    //   5: dup
    //   6: aload_0
    //   7: invokespecial 676	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   10: astore_0
    //   11: new 678	java/io/InputStreamReader
    //   14: dup
    //   15: aload_0
    //   16: invokespecial 679	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   19: astore_2
    //   20: new 217	java/lang/StringBuilder
    //   23: dup
    //   24: invokespecial 218	java/lang/StringBuilder:<init>	()V
    //   27: astore_3
    //   28: sipush 2048
    ...
    //   35: aload_2
    //   36: aload 4
    //   38: invokevirtual 683	java/io/InputStreamReader:read	([C)I
    //   41: istore_1
    //   42: iload_1
    //   43: iconst_m1
    //   44: if_icmpeq +32 -> 76
    ...
    //   50: iconst_0
    //   51: iload_1
    //   52: invokevirtual 686	java/lang/StringBuilder:append	([CII)Ljava/lang/StringBuilder;
    //   55: pop
    //   56: goto -21 -> 35
    //   59: astore 4
    //   61: aload_0
    ...
    //   65: astore_0
    //   66: aload_3
    //   67: invokestatic 688	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   70: aload_2
    //   71: invokestatic 688	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   74: aload_0
    //   75: athrow
    //   76: aload_3
    //   77: invokevirtual 231	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   80: astore_3
    //   81: aload_0
    //   82: invokestatic 688	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   85: aload_2
    //   86: invokestatic 688	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   89: aload_3
    //   90: areturn
    //   91: astore_0
    //   92: aconst_null
