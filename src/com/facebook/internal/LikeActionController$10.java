  ...
  implements RequestBatch.Callback
{
  ...
  {
    LikeActionController.access$1402(this$0, val$objectIdRequest.verifiedObjectId);
    if (Utility.isNullOrEmpty(LikeActionController.access$1400(this$0)))
    {
      LikeActionController.access$1402(this$0, val$pageIdRequest.verifiedObjectId);
      LikeActionController.access$2502(this$0, val$pageIdRequest.objectIsPage);
    }
    LikeActionController localLikeActionController;
    if (Utility.isNullOrEmpty(LikeActionController.access$1400(this$0)))
    {
      Logger.log(LoggingBehavior.DEVELOPER_ERRORS, LikeActionController.access$1000(), "Unable to verify the FB id for '%s'. Verify that it is a valid FB object or page", new Object[] { LikeActionController.access$2400(this$0) });
