  ...
  extends LikeActionController.AbstractRequestWrapper
{
  ...
  {
    Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1000(), "Error getting the FB id for object '%s' : %s", new Object[] { objectId, paramFacebookRequestError });
  }
