  ...
  extends ActionBar.Tab
{
  ...
  {
    return setContentDescription(ActionBarImplBase.access$100(this$0).getResources().getText(paramInt));
  }
  ...
  public ActionBar.Tab setContentDescription(CharSequence paramCharSequence)
  {
    ...
    if (mPosition >= 0) {
      ActionBarImplBase.access$000(this$0).updateTab(mPosition);
    }
    return this;
  }
  ...
  {
    return setIcon(ActionBarImplBase.access$100(this$0).getResources().getDrawable(paramInt));
  }
  ...
  {
    return setText(ActionBarImplBase.access$100(this$0).getResources().getText(paramInt));
  }
