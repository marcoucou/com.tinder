  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 1: 
      ...
      {
        localObject = LayoutInflater.from(this$0.getContext()).inflate(R.layout.abc_activity_chooser_view_list_item, paramViewGroup, false);
        ((View)localObject).setId(1);
        ((TextView)((View)localObject).findViewById(R.id.title)).setText(this$0.getContext().getString(R.string.abc_activity_chooser_view_see_all));
      }
      break;
    }
    View localView;
