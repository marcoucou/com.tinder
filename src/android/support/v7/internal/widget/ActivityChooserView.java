  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  public ActivityChooserView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    mInitialActivityCount = paramAttributeSet.getInt(0, 4);
    ...
    extends BaseAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      case 1: 
        ...
        {
          localObject = LayoutInflater.from(getContext()).inflate(R.layout.abc_activity_chooser_view_list_item, paramViewGroup, false);
          ((View)localObject).setId(1);
          ((TextView)((View)localObject).findViewById(R.id.title)).setText(getContext().getString(R.string.abc_activity_chooser_view_see_all));
        }
        break;
      }
      View localView;
      do
      {
        do
        {
          ...
          } while (!mShowDefaultActivity);
          localObject = localView;
        } while (paramInt != 0);
        localObject = localView;
      } while (!mHighlightDefaultActivity);
      return localView;
    }
