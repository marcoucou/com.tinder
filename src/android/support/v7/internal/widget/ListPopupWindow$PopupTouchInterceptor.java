  ...
  implements View.OnTouchListener
{
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 0) && (ListPopupWindow.access$800(this$0) != null) && (ListPopupWindow.access$800(this$0).isShowing()) && (j >= 0) && (j < ListPopupWindow.access$800(this$0).getWidth()) && (k >= 0) && (k < ListPopupWindow.access$800(this$0).getHeight())) {
      ListPopupWindow.access$1000(this$0).postDelayed(ListPopupWindow.access$900(this$0), 250L);
    }
    for (;;)
    {
      return false;
