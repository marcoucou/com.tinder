  ...
  extends View
{
  ...
  public ProgressBarICS(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    mNoInvalidate = true;
    setMax(paramAttributeSet.getInt(0, mMax));
    setProgress(paramAttributeSet.getInt(1, mProgress));
    setSecondaryProgress(paramAttributeSet.getInt(2, mSecondaryProgress));
    boolean bool2 = paramAttributeSet.getBoolean(3, mIndeterminate);
    mOnlyIndeterminate = paramAttributeSet.getBoolean(4, mOnlyIndeterminate);
    ...
    mDuration = paramAttributeSet.getInt(7, mDuration);
    mBehavior = paramAttributeSet.getInt(8, mBehavior);
    mMinWidth = paramAttributeSet.getDimensionPixelSize(9, mMinWidth);
    mMaxWidth = paramAttributeSet.getDimensionPixelSize(10, mMaxWidth);
    mMinHeight = paramAttributeSet.getDimensionPixelSize(11, mMinHeight);
    mMaxHeight = paramAttributeSet.getDimensionPixelSize(12, mMaxHeight);
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ProgressBarICS.this.doRefreshProgress(mId, mProgress, mFromUser, true);
