...
class SupportMenuInflater$MenuState
{
  ...
  public void readItem(AttributeSet paramAttributeSet)
  {
    ...
    itemCategoryOrder = (paramAttributeSet.getInt(5, groupCategory) & 0xFFFF0000 | paramAttributeSet.getInt(6, groupOrder) & 0xFFFF);
    ...
    if (paramAttributeSet.hasValue(11)) {
      if (paramAttributeSet.getBoolean(11, false))
      {
        ...
        itemEnabled = paramAttributeSet.getBoolean(1, groupEnabled);
        itemShowAsAction = paramAttributeSet.getInt(13, -1);
        itemListenerMethodName = paramAttributeSet.getString(12);
        itemActionViewLayout = paramAttributeSet.getResourceId(14, 0);
        itemActionViewClassName = paramAttributeSet.getString(15);
        itemActionProviderClassName = paramAttributeSet.getString(16);
